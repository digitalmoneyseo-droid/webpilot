...
export const metadata: Metadata = pageMetadata({ locale: "en", pathname: "/en/work", title: "Our work", description: "Selected fictional work across brand, digital, growth, and AI." });
