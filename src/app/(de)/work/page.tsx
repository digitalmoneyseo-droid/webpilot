...
export const metadata: Metadata = pageMetadata({ locale: "de", pathname: "/work", title: "Unsere Arbeiten", description: "Ausgewählte fiktive Arbeiten für Marken, Digital, Wachstum und KI." });
