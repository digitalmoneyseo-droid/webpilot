...
const scopeIcons: Record<ServiceId, readonly LucideIcon[]> = {
  "websites-apps": [LayoutTemplate, ShoppingCart, MousePointerClick, AppWindow, RefreshCw, CalendarCheck],
  ...
  return (
    ...
    >
      {groups.map((group, index) => {
        ...
        return (
          <article
            className={`flex min-h-[20rem] flex-col bg-white p-[clamp(1.5rem,3.5vw,2.5rem)] max-[800px]:col-span-12 max-[800px]:min-h-0 ${scopeLayouts[index] ?? "col-span-6"} ${scopeMotionStyles[index] ?? scopeMotionStyles[0]}`}
            data-reveal
          ...
          >
            ...
            <ul className="mt-auto grid list-none gap-3 pt-8 max-[800px]:mt-3 max-[800px]:pt-5">
