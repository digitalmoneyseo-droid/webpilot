...
export function HomePage({ locale }: { locale: Locale }) {
  ...
  return <main id="main-content">
    ...
    <section id="solutions" className="bg-canvas px-page py-section"><SectionHeading title={t(locale, "home.section1Title")} align="center" /><OfferOverview locale={locale} /></section>
