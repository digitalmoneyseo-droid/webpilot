...
import { PortfolioRibbon } from "@/components/portfolio-ribbon";
...
export function HomePage({ locale }: { locale: Locale }) {
  ...
  return <main id="main-content">
    ...
    <section id="faq" className="bg-canvas px-page py-section"><SectionHeading title={t(locale, "home.faqHeading")} align="center" /><div className="mx-auto max-w-[820px]"><Faq items={faqs} id={`home-faq-${locale}`} /></div></section><FinalCta locale={locale} singleLine />
  </main>;
}
