...
const routes = [
  ...
  "/about",
  "/insights",
  "/insights/search-is-becoming-a-recommendation-layer",
  "/insights/the-compounding-value-of-a-content-system",
  "/insights/what-to-automate-first",
  "/insights/why-brand-and-performance-belong-together",
  "/insights/a-better-b2b-website-brief",
  "/insights/measurement-for-ai-assisted-growth",
  "/contact",
  "/access",
  "/missing-page",
];
